...
const badgeVariants=cva("label inline-flex items-center gap-1 border px-1.5 py-0.5 transition-colors",{variants:{variant:{default:"border-border text-muted-foreground",primary:"border-cobalt/40 text-cobalt",success:"border-teal/40 text-teal",warning:"border-signal/40 text-signal",destructive:"border-vermilion/40 text-vermilion",outline:"border-border text-text-dim"}},defaultVariants:{variant:"default"}});
