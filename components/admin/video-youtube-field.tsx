    ...
    <div className="space-y-3">
      <div>
        ...
        <Input
          ...
          aria-describedby="youtube-detection"
        />
        ...
        parsed ? (
          <div id="youtube-detection" className="grid gap-3 border border-teal/30 bg-teal/5 p-3 sm:grid-cols-[128px_1fr]">
            <div className="relative aspect-video overflow-hidden border border-border bg-surface-3">
              <img src={parsed.thumbnailUrl} alt="Detected YouTube poster" className="h-full w-full object-cover" />
              <span className="absolute inset-0 flex items-center justify-center text-white drop-shadow"><Play className="h-5 w-5 fill-current" /></span>
            </div>
