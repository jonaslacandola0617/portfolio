    ...
    <div className="group relative aspect-video overflow-hidden border border-border bg-surface-3">
      {posterUrl ? (
        <img
          src={posterUrl}
          alt={`${title} poster`}
          className="h-full w-full object-cover transition-transform duration-500 ease-signal group-hover:scale-[1.015]"
      ...
      {embedUrl ? (
        <button
          ...
          className="absolute inset-0 flex items-center justify-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-vermilion"
        >
