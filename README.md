...
Projects, Labs, and Journal entries support downloadable resources from the shared Media Library, including custom labels, descriptions, and manual ordering in the CMS.
