...
export const metadata = buildStaticPageMetadata({
  ...
  description: "Browse published video editing and cinematography projects by Jonas Lacandola, with large-format posters and detailed case studies.",
  path: "/video/work",
